...
\name{Emanuele}{Fianco}
\address{Via G.B. Gerace 34, Rieti(RI), Italy}
\mobile{(+39) 3890221253}

\email{emanuele.fianco@gmail.com}
%\homepage{www.posquit0.com}
\github{EmanueleFianco}
%\linkedin{https://www.linkedin.com/in/emanuele-fianco-2662b3114/}
\skype{fianco.emanuele}
%\stackoverflow{SOid}{SOname}
%\twitter{@twit}
%\linkedin{Emanuele Fianco}
%\reddit{reddit account}
%\xing{xing name}
%\extrainfo{test} % Other text you want to include on this line

\position{Computer Engineer} % Your expertise/fields
%\quote{``Software is a great combination between artistry and engineering."} % A quote or statement

\makecvfooter{\today}{Emanuele Fianco}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
